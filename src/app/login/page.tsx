      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-indigo-900 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-end p-12 lg:p-20 text-white">
          ...
          <p className="text-lg lg:text-xl text-slate-200 max-w-lg leading-relaxed">
            Join TripMind and let our AI craft the perfect itinerary for your
          ...
          <div className="p-8 sm:p-10">
            <div className="text-center mb-8">
              ...
              <p className="text-slate-600 dark:text-slate-400">
                Sign in to your TripMind account
              </p>
            </div>
            ...
            <form onSubmit={handleEmailLogin} className="space-y-5">
              ...
              <button
                ...
                className="w-full py-3.5 px-4 bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-700 hover:to-violet-700 text-white rounded-xl font-bold transition-all shadow-lg shadow-indigo-500/25 flex items-center justify-center disabled:opacity-70"
              >
                {loading ? (
