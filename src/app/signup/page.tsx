    ...
    <div className="flex flex-col flex-1 items-center justify-center p-8 bg-zinc-50 font-sans dark:bg-black min-h-screen pt-24">
      <div className="w-full max-w-md bg-white dark:bg-zinc-900 rounded-2xl shadow-xl overflow-hidden border border-zinc-200 dark:border-zinc-800">
        <div className="p-8">
          ...
          <p className="text-center text-zinc-600 dark:text-zinc-400 mb-8">Join TripMind and start exploring</p>
          ...
          <form onSubmit={handleEmailSignup} className="space-y-4">
            ...
            <button
              ...
              className="w-full py-3 px-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-medium transition-colors flex items-center justify-center disabled:opacity-70 mt-2"
            >
